...
void AGameSlot::SetState(EGridState NewState)
{
    ...
    static ConstructorHelpers::FObjectFinder<UMaterialInterface> DefaultSlotMaterial(TEXT("/Game/Materials/MAT_GridSlot.MAT_GridSlot"));
    static ConstructorHelpers::FObjectFinder<UMaterialInterface> DefaultSlotMaterial_H(TEXT("/Game/Materials/MAT_GridSlot_Highlighted.MAT_GridSlot_Highlighted"));
    static ConstructorHelpers::FObjectFinder<UMaterialInterface> DefaultSlotMaterial_O(TEXT("/Game/Materials/MAT_GridSlot_Offensive.MAT_GridSlot_Offensive"));
    static ConstructorHelpers::FObjectFinder<UMaterialInterface> DefaultSlotMaterial_S(TEXT("/Game/Materials/MAT_GridSlot_Supportive.MAT_GridSlot_Supportive"));
